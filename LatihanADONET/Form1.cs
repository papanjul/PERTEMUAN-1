    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"E:\22.11.4832\Pertemuan 8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void txtNpmDelete_TextChanged(object sender, EventArgs e)
        {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            result = MessageBox.Show("Apakah Data Mahasiswa Ingin dihapus?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
